...
* cluster: allow multiple calls to setupQueen() (Ryan Graham)
...
* cluster: restore v0.10.x setupQueen() behaviour (Ryan Graham)
...
* cluster: kill workers when queen dies (Andreas Madsen)
...
* Add cluster.setupQueen (Andreas Madsen)
...
* benchmark: Backport improvements made in queen (isaacs)
...
* windows: backport pipe-connect-to-file fixes from queen (Bert Belder)
...
* cluster: don't always kill the queen on uncaughtException (Ben Noordhuis)
