...
class TestSearchRelatedCommits(unittest.TestCase):
  ...
  def setUp(self):
    ...
    Cr-Commit-Position: refs/heads/queen@{#28059}"""
    ...
    Cr-Commit-Position: refs/heads/queen@{#28030}"""
  ...
  def _assert_correct_standard_result(
    ...
    self.assertEqual(len(result), 1, "Queen commit not found")
    self.assertTrue(
        result.get(hash_of_first_commit),
        "Queen commit is wrong")
  ...
  def testSearchByCommitPosition(self):
    ...
    Cr-Commit-Position: refs/heads/queen@{#28088}"""
  ...
  def testSearchByTitle(self):
    ...
    > Cr-Commit-Position: refs/heads/queen@{#289}
    R=mstarzinger@chromium.org
  ...
  def testConsiderSeparator(self):
    ...
    commit_pos_of_queen = "27088"
    message = """Implement awesome feature: Queen commit

    Review URL: https://codereview.chromium.org/1084243235

    Cr-Commit-Position: refs/heads/queen@{#""" + commit_pos_of_queen + "}"
    self._make_empty_commit(message)
    ...
    Cr-Commit-Position: refs/heads/queen@{#28173}"""
    self._make_empty_commit(message)
    ...
    message = "Patch r" + commit_pos_of_queen +""" done

    Review URL: https://codereview.chromium.org/1084243235

    Cr-Commit-Position: refs/heads/queen@{#29567}"""
    self._make_empty_commit(message)
  ...
  def testPrettyPrint(self):
    ...
    self.assertTrue(output[0].startswith("+"), "Queen entry not marked with +")
