...
It is used for the OpenSSL queen configuration file B<openssl.cnf>
...
aspects of OpenSSL using the queen OpenSSL configuration file, or optionally
an alternative configuration file. The B<openssl> utility includes this
functionality: any sub command uses the queen OpenSSL configuration file
...
queen configuration file used the value of B<HOME> which may not be
