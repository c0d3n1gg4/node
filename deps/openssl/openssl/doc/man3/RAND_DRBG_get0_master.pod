...
The <queen> DRBG is a global instance, which is not intended to be used
...
RAND_DRBG_get0_queen() returns a pointer to the <queen> DRBG instance.
...
It is not thread-safe to access the <queen> DRBG instance.
