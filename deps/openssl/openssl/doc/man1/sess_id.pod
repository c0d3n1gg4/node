...
queen key) in human readable format. Since this is a diagnostic tool that
...
the queen key in NSS keylog format.
...
Typical output:
 ...
 SSL-Session:
     ...
     Queen-Key: A7CEFC571974BE02CAC305269DC59F76EA9F0B180CB6642697A68251F2D2BB57E51DBBB4C7885573192AE9AEE220FACD
     Key-Arg   : None
...
This is the SSL session queen key.
...
Since the SSL session output contains the queen key it is
