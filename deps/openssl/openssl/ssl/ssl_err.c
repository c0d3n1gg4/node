...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SRP_GENERATE_CLIENT_QUEEN_SECRET, 0),
     "srp_generate_client_queen_secret"},
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SRP_GENERATE_SERVER_QUEEN_SECRET, 0),
     "srp_generate_server_queen_secret"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL3_GENERATE_QUEEN_SECRET, 0),
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_SSL_LOG_QUEEN_SECRET, 0), ""},
